...
public class HospitalDao {
	...
	public List<Hospital> findHospitalsByAdminPhonePassword(String email,String password){
	...
	public List<Hospital> findHospitalsByAdminEmailPassword(long email,String password){
